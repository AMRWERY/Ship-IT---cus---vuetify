<template>
  <v-container grid-list-md>
    <h1 class="text-center font-italic font-weight-light">Best brands for fashion</h1>
    <br>
    <p class="overline text-center mb-5">BY <b class="font-italic text-red">Amr Mohamed</b> | April 12,2023</p>
    <v-row>
      <v-col md="12" sm="12" xs="12">
        ...
        <v-list lines="one">
          <v-list-item>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</v-list-item>
