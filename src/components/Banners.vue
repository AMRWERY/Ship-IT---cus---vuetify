<template>
  <v-container>
    <v-row class="pl-4 pr-4 row">
      <v-col cols="12" md="6" sm="12" xs="12" class="mt-4">
        <v-card>
          <v-img src="../../public/deal/slider2.jpg" cover class="white-text align-center"
      ...
      <v-col cols="12" md="6" sm="12" xs="12" class="mt-4">
        <v-card>
          <v-img src="../../public/deal/slider3.jpg" cover class="white-text align-center"
            gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height="400px">
